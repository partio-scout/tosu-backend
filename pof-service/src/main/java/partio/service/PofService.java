...
public class PofService extends RestTemplate {
    ...
    //get tasks from POF data for given agegroup
    ...
    private JsonNode writeCustomActivity(JsonNode task) throws IOException {
        ...
        //source url
        activity.set("mandatoryIconUrl", task.findValue("tags").findValue("pakollisuus").get(0).findValue("icon"));
